...
import com.zhzh.model.common.BaseEntity;
...
public class SysMenu extends BaseEntity
{
    ...
    /** 组件路径 */
    @ApiModelProperty(value = "组件路径" ,example = "1")
    private String component;

    /** 是否为外链（0是 1否） */
    @ApiModelProperty(value = "是否为外链" ,example = "0是 1否）")
    private String isFrame;

    /** 类型（M目录 C菜单 F按钮） */
    @ApiModelProperty(value = "类型" ,example = "（M目录 C菜单 F按钮）")
    private String menuType;

    /** 显示状态（0显示 1隐藏） */
    @ApiModelProperty(value = "显示状态" ,example = "（0显示 1隐藏）")
    private String visible;
    
    /** 菜单状态（0显示 1隐藏） */
    @ApiModelProperty(value = "菜单状态" ,example = "（0显示 1隐藏）")
